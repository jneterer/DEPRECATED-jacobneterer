...
const MyProjects: React.FC = () => {
  return (
    <div className="container section">
      ...
      <ul>
        <li>
          My Data Labeler is an open-source text classification tool. It is still a work in progress and will hopefully
          be completed sometime early this year (2020). It is built on Angular as the front-end,
          MongoDB as the database, and MongoDB Stitch for user management and a server-less back-end. I am hoping
          to have a website for this project in the near future.
        </li>
        <li>
